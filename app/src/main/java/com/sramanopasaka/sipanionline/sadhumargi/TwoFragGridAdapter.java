...
class TwoFragGridAdapter extends BaseAdapter {

    ArrayList<RamSahitya> ramsahityArrayList;
    Context context;
    ImageLoader imageLoader;


    public TwoFragGridAdapter(FragmentActivity activity, ArrayList<RamSahitya> arrayList) {

        this.context = activity;
        this.ramsahityArrayList = arrayList;
        imageLoader = new ImageLoader(context);
    }

    @Override
    public int getCount() {
        return ramsahityArrayList.size();
    }
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        final RamSahitya model = ramsahityArrayList.get(i);
...
//        final ViewHolder holder =null;
        ...
        if (view == null) {
            ...
            grid = inflater.inflate(R.layout.activity_two_frag_adapter, null);

            TextView txtTitle = (TextView) grid.findViewById(R.id.twofrag_txt_date);
            ImageView imageView = (ImageView)grid.findViewById(R.id.twofrag_image);
            txtTitle.setText(ramsahityArrayList.get(i).getTitle());
...
//            imageLoader.DisplayImage(url2, imageView );
        ...
        grid.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(isConnected)
                {
                    String encode=ramsahityArrayList.get(i).getRam_sah_id();
                    try {
                        String query = URLEncoder.encode(encode, "utf-8");
                        Log.e("Encode values","Success///"+query);
                        String a1=ramsahityArrayList.get(i).getDate();
