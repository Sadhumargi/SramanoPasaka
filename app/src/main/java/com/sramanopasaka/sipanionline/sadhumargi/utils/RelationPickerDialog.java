...
import com.sramanopasaka.sipanionline.sadhumargi.adapters.RelationPickerAdapter;
...
public class RelationPickerDialog extends Dialog implements RelationPickerAdapter.Callback {

    private RelationsChangeListener sanghChangeListener;
    private List<String> mFilteredZone;
    private List<Relations> zoneList = null;
    private Context context = null;
    private  RecyclerView zone_dialog_rv;
    private String  title = null;

    public RelationPickerDialog(@NonNull Context context, List<Relations> zoneList,String title) {
        super(context);
    ...
    public void setRelationsChangeListner(RelationsChangeListener zoneChangeListner) {
    ...
    private void setupData() {
        ...
        RelationPickerAdapter zonePickerAdapter = new RelationPickerAdapter(zoneList,this);
    ...
    @Override
    public void onRelationSelected(String relation, String id) {
        sanghChangeListener.onRelationSelected(relation,id);
    }
